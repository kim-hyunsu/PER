...
SLxy2 = Embed(SL(2), 4 , slice(2))
SLyz2 = Embed(SL(2), 4 , slice(1,3))
SLxz2 = Embed(SL(2), 4 , slice(0,3,2))
    ...
    for trial in range(args.trials):
        if "soft" in args.network.lower():
            watermark = "{}sym_{}_eq{}_wd{}_gt{}_t{}".format(
                args.experiment ,args.network, args.equiv, args.wd, args.gated_wd, trial)
        else:
            watermark = "{}sym_{}_eq{}_bs{}_gt{}_t{}".format(
                args.experiment ,args.network, args.equiv_wd, args.basic_wd, args.gated_wd, trial)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="mis-",
        help="type of network {perfect-, unbalanced-, mis-}",
    )
    parser.add_argument(
        "--basic_wd",
        type=str,
    ...
    parser.add_argument(
        "--equiv",
        type=str,
        default="200, 0 0"  # "200" for o3softemlp, "200,200" for o2o3softemlp, "1" for o2o3softmixedemlp, "200,0,0,0" for hybridsoftemlp
    )
    parser.add_argument(
        "--wd",
        type=float,
